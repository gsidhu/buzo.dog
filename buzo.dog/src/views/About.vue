<template>
  <div class='about col-sm-9 mx-auto my-4'>
    <h3>What is this site?</h3>
    <p>Buzo.dog is a no nonsense internet explorer. The internet has all sorts of beautiful weirdness to it. Buzo helps you explore it.</p>
    ...
    <avatar
          ...
          skinColor='Brown'
        />
      <p class='text-muted'>Mysterious Turban Man</p>
  </div>
</template>
